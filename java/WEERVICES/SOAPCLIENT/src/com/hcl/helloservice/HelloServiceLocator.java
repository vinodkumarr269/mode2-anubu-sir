...
public class HelloServiceLocator extends org.apache.axis.client.Service implements com.hcl.helloservice.HelloService {
    ...
    private java.lang.String HelloPort_address = "http://127.0.0.1:1111/Hello";
    ...
    public com.hcl.helloservice.Hello getHelloPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.hcl.helloservice.HelloPortBindingStub _stub = new com.hcl.helloservice.HelloPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.hcl.helloservice.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                com.hcl.helloservice.HelloPortBindingStub _stub = new com.hcl.helloservice.HelloPortBindingStub(new java.net.URL(HelloPort_address), this);
                _stub.setPortName(getHelloPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://helloservice.hcl.com/", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://helloservice.hcl.com/", "HelloPort"));
        }
