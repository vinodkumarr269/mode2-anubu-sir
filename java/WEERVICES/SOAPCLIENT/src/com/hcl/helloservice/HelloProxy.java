...
public class HelloProxy implements com.hcl.helloservice.Hello {
  private String _endpoint = null;
  private com.hcl.helloservice.Hello hello = null;
  ...
  private void _initHelloProxy() {
    try {
      hello = (new com.hcl.helloservice.HelloServiceLocator()).getHelloPort();
      if (hello != null) {
        if (_endpoint != null)
  ...
  public com.hcl.helloservice.Hello getHello() {
    if (hello == null)
      _initHelloProxy();
    return hello;
  }
