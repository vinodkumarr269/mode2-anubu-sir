...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.hcl.demo.HelloWorldService {
    ...
    private java.lang.String HelloWorldPort_address = "http://127.0.0.1:1111/HelloWorld";
    ...
    public com.hcl.demo.HelloWorld getHelloWorldPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.hcl.demo.HelloWorldPortBindingStub _stub = new com.hcl.demo.HelloWorldPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.hcl.demo.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                com.hcl.demo.HelloWorldPortBindingStub _stub = new com.hcl.demo.HelloWorldPortBindingStub(new java.net.URL(HelloWorldPort_address), this);
                _stub.setPortName(getHelloWorldPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://demo.hcl.com/", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://demo.hcl.com/", "HelloWorldPort"));
        }
