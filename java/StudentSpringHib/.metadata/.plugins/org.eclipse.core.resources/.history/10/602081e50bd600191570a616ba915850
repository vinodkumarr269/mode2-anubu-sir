...
public class StudentController {
	...
	public ModelAndView newMark(ModelAndView model) {
		model.setViewName("addMarks");
		return model;
	}
	@RequestMapping(value = "/addMarks1", method = RequestMethod.POST)
	public ModelAndView addMarks(@ModelAttribute Exam exam) {
